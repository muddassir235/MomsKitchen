 ...
 * {@link AdminDeliveredMealsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AdminDeliveredMealsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminDeliveredMealsFragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public AdminDeliveredMealsFragment() {
     ...
     * this fragment
     * @return A new instance of fragment AdminDeliveredMealsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AdminDeliveredMealsFragment newInstance() {
        AdminDeliveredMealsFragment fragment = new AdminDeliveredMealsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_admin_delivered_meals, container, false);
        ...
        final PendingOrdersAdapter adapter = new PendingOrdersAdapter(PendingOrdersAdapter.TYPE_ADMIN_PENDING_ORDERS_LIST,PendingOrdersAdapter.STATUS_RECIEVED);
        ...
        adapter.setDataLoadedListener(new PendingOrdersAdapter.DataLoadedListener() {
            ...
            public void dataLoaded(int size) {
                ...
                if(size == 0){
                    ...
                    emptyListTextView.setText("No Packages Delivered Yet");
