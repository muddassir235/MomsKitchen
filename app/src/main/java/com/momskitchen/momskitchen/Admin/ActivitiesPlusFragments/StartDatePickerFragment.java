...
public class StartDatePickerFragment extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        int year = Integer.valueOf(MenuCreationActivity.startDate.substring(0,4));
        int month = Integer.valueOf(MenuCreationActivity.startDate.substring(4,6))-1;
        int day = Integer.valueOf(MenuCreationActivity.startDate.substring(6,8));
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        MenuCreationActivity.startDate = MenuCreator.getInstance().getDateFromCalendar(calendar);
        ...
        if(Integer.valueOf(MenuCreationActivity.startDate)>Integer.valueOf(MenuCreationActivity.endDate)){
            MenuCreationActivity.endDate = MenuCreationActivity.startDate;
            MenuCreationActivity.mEndDateTV.setText(dateString);
        }
        MenuCreationActivity.mStartDateTV.setText(dateString);
        MenuCreationActivity.dates = MenuCreator.getInstance().getDatesBetweenStartAndEndDate(MenuCreationActivity.startDate,MenuCreationActivity.endDate);
