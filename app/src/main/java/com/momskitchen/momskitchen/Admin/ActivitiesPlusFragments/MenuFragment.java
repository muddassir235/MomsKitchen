 ...
 */
public class MenuFragment extends Fragment implements AdminMenuListFragment.OnListFragmentInteractionListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mealsListFragmentsPagerAdapter = new MealsListFragmentsPagerAdapter(getChildFragmentManager(),MealsListFragmentsPagerAdapter.ADMIN_MENU_LIST);
        ...
        FloatingActionButton floatingActionButton = (FloatingActionButton) rootView.findViewById(R.id.add_new_menu_fab);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),MenuCreationActivity.class);
                intent.putExtra("CurrentDate", MenuCreator.getInstance().getDateFromCalendar(AdminMainActivity.currentCalendar));
