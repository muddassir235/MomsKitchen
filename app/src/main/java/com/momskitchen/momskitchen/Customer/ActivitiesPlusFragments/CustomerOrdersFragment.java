 ...
 * {@link CustomerOrdersFragment.OnFragmentInteractionListener} interface
...
public class CustomerOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_customer_orders, container, false);
        ...
        final PendingOrdersAdapter adapter = new PendingOrdersAdapter(PendingOrdersAdapter.TYPE_CUSTOMER_PENDING_ORDERS_LIST,PendingOrdersAdapter.STATUS_PENDING);
        ...
        adapter.setDataLoadedListener(new PendingOrdersAdapter.DataLoadedListener() {
            ...
            public void dataLoaded(int size) {
                ...
                if(size == 0){
                    ...
                    emptyListTextView.setText("No Orders Yet!");
