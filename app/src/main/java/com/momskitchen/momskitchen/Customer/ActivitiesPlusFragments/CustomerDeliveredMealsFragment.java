 ...
 * {@link CustomerDeliveredMealsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link CustomerDeliveredMealsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CustomerDeliveredMealsFragment extends Fragment {
    private OnFragmentInteractionListener mListener;

    public CustomerDeliveredMealsFragment() {
     ...
     * this fragment
     * @return A new instance of fragment CustomerDeliveredMealsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CustomerDeliveredMealsFragment newInstance() {
        CustomerDeliveredMealsFragment fragment = new CustomerDeliveredMealsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_customer_delivered_meals, container, false);
        ...
        final PendingOrdersAdapter adapter = new PendingOrdersAdapter(PendingOrdersAdapter.TYPE_CUSTOMER_PENDING_ORDERS_LIST,PendingOrdersAdapter.STATUS_RECIEVED);
        ...
        adapter.setDataLoadedListener(new PendingOrdersAdapter.DataLoadedListener() {
            ...
            public void dataLoaded(int size) {
                ...
                if(size == 0){
                    ...
                    emptyListImageView.setImageResource(R.drawable.recieved_icon);
                    emptyListTextView.setText("No Meals Recieved Yet");
