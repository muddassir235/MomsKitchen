...
import com.momskitchen.momskitchen.Admin.MealAdapterAdmin;
...
public class AdminMenuListFragment extends Fragment {
    ...
    private static final String TAG = "AdminMenuListFragment: ";
    ...
    public static MealAdapterAdmin lunchListAdapter;
    public static MealAdapterAdmin dessertListAdapter;
    public static MealAdapterAdmin complimentListAdapter;
     ...
     */
    public AdminMenuListFragment() {
    }

    // TODO: Customize parameter initialization
    @SuppressWarnings("unused")
    public static AdminMenuListFragment newInstance(int positon,int columnCount) {
        AdminMenuListFragment fragment = new AdminMenuListFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_admin_menu_list, container, false);
        ...
        // Set the adapter
        currentDate = MenuCreator.getInstance().getDateFromCalendar(AdminMainActivity.currentCalendar);
        ...
        if(position == 1){
            ...
            lunchListAdapter = new MealAdapterAdmin(getActivity(),currentDate,
            ...
            dessertListAdapter = new MealAdapterAdmin(getActivity(),currentDate,
            ...
            complimentListAdapter = new MealAdapterAdmin(getActivity(),currentDate,
    ...
    public void makeEmptyListLayoutsVisible(){
