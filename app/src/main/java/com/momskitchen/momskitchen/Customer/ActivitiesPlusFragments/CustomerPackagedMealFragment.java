 ...
 * {@link CustomerPackagedMealFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link CustomerPackagedMealFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CustomerPackagedMealFragment extends Fragment {


    private OnFragmentInteractionListener mListener;

    public CustomerPackagedMealFragment() {
     ...
     * this fragment
     * @return A new instance of fragment CustomerPackagedMealFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CustomerPackagedMealFragment newInstance() {
        CustomerPackagedMealFragment fragment = new CustomerPackagedMealFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_customer_packaged_meal, container, false);
        ...
        final PendingOrdersAdapter adapter = new PendingOrdersAdapter(PendingOrdersAdapter.TYPE_CUSTOMER_PENDING_ORDERS_LIST,PendingOrdersAdapter.STATUS_PACKAGED);
        ...
        adapter.setDataLoadedListener(new PendingOrdersAdapter.DataLoadedListener() {
            ...
            public void dataLoaded(int size) {
                ...
                if(size == 0){
                    ...
                    emptyListTextView.setText("Your meal will get packaged soon :)");
